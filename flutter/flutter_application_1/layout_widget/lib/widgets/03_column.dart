...
class _MyHomePageState extends State<MyHomePage>{
  ...
  Widget build(BuildContext context) {
    ...
    body: const Column(
      mainAxisSize: MainAxisSize.max,//mainAxisSize = column 안에서는 세로를 기준 삼아 차지하는 영역
      mainAxisAlignment: MainAxisAlignment.spaceAround,//mainAxisAlignment = column 안에서는 세로를 기준 삼아서 정렬
      crossAxisAlignment: CrossAxisAlignment.stretch,//정렬
      children:<Widget>[
        Text('1', style: TextStyle(fontSize: 30.0),),
        Text('2', style: TextStyle(fontSize: 130.0),),
        Text('3', style: TextStyle(fontSize: 80.0),) //이 모든 것이 개별의 위젯이다.
      ], //row위젯은 자식요소를 여러개 가짐
    ),
    );
  } 
